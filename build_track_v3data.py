...
OUT = Path(os.environ.get("TRACK_OUT", "track_build/track_windows_v3data.npz"))
INPUT_DIM = 48  # 40 base + 8 motion-dynamics (heading sin/cos, speed, turn, dvmax, dpres, +2 validity)
