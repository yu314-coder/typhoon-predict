...
src = open("train_track_v11.py").read()
...
ck = torch.load("track_build/track_v11_best.pt", map_location="cpu", weights_only=False)
...
def build(storm):
    ...
    json.dump(d, open(f"track_build/{storm["out"]}_v11_geo.json", "w"))
    return errs
