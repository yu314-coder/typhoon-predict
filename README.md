...
part of the model package. The model weights are distributed as the release
archive rather than committed into the Git history.
...
this matched-storm benchmark. The chart below is the canonical comparison;
...
validated causal OHC/D26/D20 calibration around the frozen incumbent anchor. It
