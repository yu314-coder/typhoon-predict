"""v10.2 on Colab — v10.1 with Typhoon Tip (1979) HELD OUT of training.

    !wget -q -O v21.py https://raw.githubusercontent.com/yu314-coder/typhoon-predict/main/colab_v21.py
    exec(open('v21.py').read())

WHY v10.2 EXISTS. Extending the record to 1950 swept 1979 into the training split, so v10.1 had
...
N_SEEDS = int(os.environ.get("V21_SEEDS", "3"))
...
print("v10.2 trained:", len(CK), flush=True)
