...
V3 = build_v3()
zc = np.load("track_build/track_windows_v8.npz", allow_pickle=True)
...
m6 = load(V3, "track_build/track_v8_best.pt")
print("\n=== v8 (1980+ partial-lead only) on full-20-lead 2020+ ===")
...
print(f"storm-bootstrap (v8-v3): mean {diffs.mean():+.1f}, 95% CI [{lo:+.1f},{hi:+.1f}], P(v8 better)={(diffs<0).mean():.3f}")
